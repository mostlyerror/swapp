      ...
      <div>
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <label
            ...
            className="pl-1 md:pl-2 block md:inline text-sm md:text-xl font-semibold"
          >
          ...
          <Switch
            ...
            className={classNames(
              ...
              "mt-2 md:mt-0 relative inline-flex flex-shrink-0 h-10 w-full md:w-1/4 border border-transparent rounded cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-indigo-500"
            )}
          >
            <input
              type="radio"
